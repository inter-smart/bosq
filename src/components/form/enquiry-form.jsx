...
// ✅ Shared styles
const labelStyle = cn(
  "text-[12px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[18px] leading-none font-light text-[#282828]"
);
      ...
      >
          ...
          render={({ field }) => (
            <FormItem className="w-full">
              <FormLabel className={labelStyle}>
                Name<span className="text-[#f17423]">*</span>
              </FormLabel>
              <FormControl>
                <Input
                  {...field}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-full sm:w-1/2">
              <FormLabel className={labelStyle}>
                Phone Number<span className="text-[#f17423]">*</span>
              </FormLabel>
              <FormControl>
                <Input
                  {...field}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-full sm:w-1/2">
              <FormLabel className={labelStyle}>
                Email ID<span className="text-[#f17423]">*</span>
              </FormLabel>
              <FormControl>
                <Input
                  {...field}
