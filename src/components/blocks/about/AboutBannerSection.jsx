      ...
      <div className="w-full aspect-6/5 sm:aspect-1920/740 overflow-hidden flex items-center relative z-0">
        {data?.media?.media_type === "image" ? (
          <picture className="absolute -z-2 inset-0 opacity-95">
            <source
              ...
              srcSet={
                isEn ? data?.media?.mobilePath : data?.media?.mobilePath_ar
              }
            />
            <Image
              src={
                isEn
                  ? data?.media?.desktopPath
                  : (data?.media?.desktopPath_ar ?? "/images/placeholder.jpg")
              }
        ...
        <div className="container">
          <div className="w-full xl:max-w-1/2 py-15 xl:py-20 2xl:py-25">
            ...
            <Button variant={"white"} className="min-w-0 px-4 2xl:px-7" asChild>
