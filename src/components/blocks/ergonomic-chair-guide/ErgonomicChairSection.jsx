    ...
    <section className="w-full h-auto py-[10px_40px] sm:py-[10px_50px] lg:py-[20px_70px] 2xl:py-[30px_90px] block">
      ...
      <div className="container pt-7 sm:pt-10 lg:pt-17 2xl:pt-20 3xl:pt-25">
        {data?.sections?.map((item) => (
          <div key={item.id} className="w-full h-auto py-2.5 sm:py-5 lg:py-8 2xl:py-10 3xl:py-12 first:pt-0 last:pb-0 block">
            <div
              className={cn(
                "w-full h-auto md:[&>div]:px-5 2xl:[&>div]:px-7 md:-mx-5 2xl:-mx-7 flex flex-wrap md:flex-row items-center",
            ...
            >
              <div className="w-full md:w-1/2 max-sm:mb-2.5 max-md:mb-5">
                <div className="w-full h-auto py-7.5 bg-[#F4F4F4] relative z-0">
                  ...
                  <div
                    className={cn(
                      "text-[35px] sm:text-[45px] lg:text-[65px] 2xl:text-[80px] 3xl:text-[100px] leading-1 font-bold text-[#282828] mx-8 lg:mx-12 2xl:mx-15 3xl:mx-20 opacity-[0.1] absolute z-1 inset-[0_auto_0_0] flex items-center",
                      item?.id % 2 === 0 && "inset-[0_0_0_auto]"
                    )}
                  >
                    {item?.id}
                  </div>
              ...
              <div className="w-full md:w-1/2">
                <div className="w-full h-auto">
                  <Heading as="h2" size="heading1" className="line-clamp-2 text-black mb-4 sm:mb-5 2xl:mb-7.5 3xl:mb-8.5">
                    {/* {parse( item?.title)} */}
