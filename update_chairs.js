...
const pagePath = path.join(__dirname, 'src', 'app', '[locale]', '(public)', 'office-chairs', 'page.js');
...
const newProductsStr = JSON.stringify(newProducts, null, 2).replace(/\n/g, '\n      ');

const regex = /coupons:\s*\[[\s\S]*?\],\s*\},/g;
