...
export default function OrderSuccess({ status, orderRef, locale = "en" }) {
  ...
  return (
    <div dir={locale === "ar" ? "rtl" : "ltr"} className="w-full py-[30px] sm:py-[40px] xl:py-[60px] 2xl:py-[100px]">
      <Empty>
        <EmptyHeader>
          <EmptyMedia>
            <Image src={config.icon} alt={status} width={100} height={100} className="w-[30px] xl:w-[50px]" quality={90} />
          </EmptyMedia>
