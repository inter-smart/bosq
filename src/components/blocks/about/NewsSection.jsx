...
import { DotButton, useDotButton } from "@/components/utils/embla-carousel-dot-button";
    ...
    <section id="news" className="w-full h-auto py-10 sm:py-20 lg:py-25 2xl:py-30 3xl:py-38 block">
      <div className="container">
        <div className="mb-5 lg:mb-7 2xl:mb-10 flex items-center">
          <div className="w-1/2">
            <Heading as="h1" size="heading1" className="leading-tight text-[#282828]">
              {parse(data?.title)}
              <span
                className={cn(
                    ...
                    <div className="[&_div]:text-[13px] lg:[&_div]:text-[14px] 2xl:[&_div]:text-[16px] 3xl:[&_div]:text-[18px] [&_div]:leading-[1.2] [&_div]:font-light [&_div]:text-[#B1B2B4] mb-2.5 2xl:mb-3.5 flex flex-wrap items-center gap-4">
                      <div
                        className={cn(
                          ...
                          locale === "ar" ? "pr-7 2xl:pr-10 before:inset-[0_0_0_auto]" : "pl-7 2xl:pl-10 before:inset-[0_auto_0_0]",
                        )}
                      >
                        {item?.name}
                      </div>
                      <div
                        className={cn(
                          ...
                          locale === "ar" ? "pr-3 2xl:pr-5 before:inset-[0_0_0_auto]" : "pl-3 2xl:pl-5 before:inset-[0_auto_0_0]",
                        )}
                      >
                        {item?.date}
                      </div>
          ...
          <div className="flex justify-center mt-15 xl:mt-20 gap-2 2xl:gap-3">
            {scrollSnaps.map((_, index) => (
              <DotButton
                ...
                className={cn("w-2.25 2xl:w-3 h-2.25 2xl:h-3 bg-[#D9D9D9]", index === selectedIndex && "bg-[#282828]")}
              />
            ))}
          </div>
        )}
