        ...
        <section className="w-full h-auto py-10 sm:py-20 lg:py-30 2xl:py-60 3xl:py-70 block">
            <div className="container">
                <div className="w-full h-auto lg:px-15 xl:px-25 2xl:px-30 3xl:px-38 flex items-center max-sm:flex-col relative z-0">
                    <div className={cn("w-50 sm:w-70 lg:w-100 2xl:w-118 3xl:w-148 h-auto aspect-square max-sm:mb-5 relative sm:absolute -z-1", locale === "ar" ? "lg:right-15 xl:right-25 2xl:right-30 3xl:right-38" : "lg:left-15 xl:left-25 2xl:left-30 3xl:left-38")}>
                        <Heading
                            as="h1"
                            size="heading1"
                        ...
                        <div className={cn("w-full h-full absolute -z-1 inset-0 block", locale === "ar" && "scale-x-[-1]")}>
                            <Image
                    ...
                    <div className="flex sm:flex-col max-sm:mt-5 sm:py-2 gap-2 2xl:gap-3">
